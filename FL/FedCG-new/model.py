...
class ResNet(nn.Module):
    def __init__(self, hidden_size, n_class=10, input_channel=3, block=Block, num_blocks=[2, 2, 2, 2]):
...
def ResNet18(hidden_size, n_class):
    return ResNet(hidden_size, n_class, num_blocks=[2, 2, 2, 2])


def ResNet152(hidden_size, n_class):
    return ResNet(hidden_size, n_class, num_blocks=[3, 8, 36, 3])
