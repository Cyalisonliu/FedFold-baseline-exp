...
import pandas as pd
from model import Conv, MLP, ResNet18, ResNet152
...
def set_parameters(cfg):
    if cfg['dataset'] == 'CIFAR10':
        if cfg['model'] == 'CNN':
            ...
            model_fn = ResNet18  # for CIFAR10 with ResNet
        cfg['n_class'] = 10
        if len(cfg['train_ratio'].split('-')) == 3 or model_fn == ResNet18:
