...
cfg = {
    'model_checkpoint': f'./output/{args.dataset}/{args.model}/{args.strong}_{args.weak}/{args.checkpoint}_run_noniid={args.n_split}/best_model.pt',  # Path to the saved model
    'dataset': args.dataset,
    'model': args.model,
    'batch_size': args.batch_size,
    'n_device': 100,
    'n_split': args.n_split,
    'non_iid_type': 'FedLamp p partition',
    'p': 0.8,
    'val_ratio': 0.2,
    'seed': 2,
}
